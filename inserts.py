...
def criar_personagens_exemplo():
    ...
    if not Feral.query.filter_by(nome=tesouro_feral.nome).first():
        tesouro_utensílio = Utensilio(
            nome='Cutelo',
            alcance='1',
        ...
        tesouro_feral.utensilios.append(tesouro_utensílio)
    ...
    if not Feral.query.filter_by(nome=besouro_feral.nome).first():
        besouro_utensílio = Utensilio(
            nome='Panela',
            alcance='1',
            se_quebrado='Alcance: 1 (GOLPEAR). Esta Parte causa metade do Dano.',
        ...
        besouro_feral.utensilios.append(besouro_utensílio)
